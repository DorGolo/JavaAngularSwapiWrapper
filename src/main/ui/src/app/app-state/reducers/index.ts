...
export interface State {
    createPerson: fromCreatePerson.State;
...
export const reducers: ActionReducerMap<State> = {
    createPerson: fromCreatePerson.reducer,
...
const reducerKeys = ['loggedinperson'];
...
export const getCreatePersonState = createFeatureSelector<fromCreatePerson.State>('createPerson');

export const getPeople = createSelector(
  getCreatePersonState,
  fromCreatePerson.getPeople
);
